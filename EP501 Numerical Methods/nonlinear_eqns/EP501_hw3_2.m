...
x1=newton_approx(f,0.5+0.5i,1000,1e-6);

f2=@(x) (x^3-3*x^2+4*x-2)/(x-x1);

x2=newton_approx(f2,0.5-0.5i,1000,1e-6);

f3=@(x) (x^3-3*x^2+4*x-2)/(x-x1)/(x-x2);

x3=newton_approx(f3,0.5+0.5i,1000,1e-6);
